      ...
      {colorPalette.map((color, index) => (
        <div
          ...
          className={`color-div transform-gpu transition-transform duration-[200ms] 
            ...
            ${project.name === "doxy.me"
              ? "group-hover:translate-y-[20%]"
              : ""
            }
            ${project.name === "InMoment.com"
              ? "translate-x-0 group-hover:-translate-y-[20%]"
              : ""
            }
            ${project.name === "Yoli"
              ? "translate-x-0 group-hover:-translate-y-[10%] group-hover:-translate-x-[10%]"
              : ""
            }`}
          style={{
            ...
            left: project.name === "Yoli" ? `${((index / colorPalette.length) * 100).toFixed(2)}%` : undefined,
          }}
        />
      ))}
    </div>
