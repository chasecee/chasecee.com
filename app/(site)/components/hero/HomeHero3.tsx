...
export default function HomeHero({
  ...
  return (
    <div
      className={`my-20 flex flex-col justify-center from-neutral-100 to-neutral-200 py-20 dark:from-neutral-700 dark:to-neutral-800 md:rounded-xl md:bg-gradient-radial md:px-4 md:py-24  lg:mt-24 lg:h-screen lg:max-h-[80dvh] lg:min-h-[31rem] lg:py-0 ${className}`}
    >
      <div
