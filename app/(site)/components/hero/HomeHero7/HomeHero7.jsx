...
const HomeHero7 = () => {
  return (
    <div className="center-container intro lg:aspect-16/7 relative mb-20 mt-24 flex aspect-square flex-col items-center justify-center overflow-hidden rounded-xl [clip-path:inset(0)] md:max-h-[80vh]">
      ...
      <div className="prose max-w-full">
        <h1 className="title z-1 relative text-center text-[clamp(20px,7vw,60px)] text-black dark:text-white">
