            ...
            structure: (S, context) => {
              return S.list()
                ...
                .items([
                    ...
                    orderableDocumentListDeskItem({type: 'project',title: 'Projects', icon:ImagesIcon, S, context},),
                    orderableDocumentListDeskItem({type: 'page',title: 'Pages', icon:DocumentsIcon, S, context},) // This becomes the new 'Projects' list
                ])
            },
          }),
          codeInput(),colorInput()],
