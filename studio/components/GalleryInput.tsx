...
type GalleryImage = ImageValue & { _key: string; alt?: string };
...
function GalleryArrayFunctions(
  props: ArrayInputFunctionsProps<GalleryImage, ArrayOfObjectsInputProps["schemaType"]>,
) {
...
export default function GalleryInput(props: ArrayOfObjectsInputProps<GalleryImage>) {
