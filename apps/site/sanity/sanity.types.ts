...
// Query: *[_type == "project" && slug.current == $slug][0]{  _id,  _type,  "isDraft": _id in path("drafts.**") || _originalId in path("drafts.**"),  _createdAt,  name,  "slug": slug.current,  "image": image.asset->url,  type,  subtitle,  svgcode,  url,  archived,  orderRank,  "leadIn": leadIn[]{  ...,  markDefs[]{  ...,  _type == "internalLink" => {    "slug": @.reference->slug.current,    "refType": @.reference->_type  },  _type == "link" => {    ...,  }},  _type == "media" => {  ...,  media{    ...,    asset->{  _id,  url,  mimeType,  originalFilename,  size}  }},  _type == "videoFile" => {  ...,  asset->{  _id,  url,  mimeType,  originalFilename,  size},  poster{  ...,  asset->{    _id,    url,    mimeType,    metadata{      dimensions    }  }}},  _type == "gallery" => {  ...,  images[]{    ...,    _type == "galleryVideo" => {      ...,      asset->{  _id,  url,  mimeType,  originalFilename,  size},      poster{  ...,  asset->{    _id,    url,    mimeType,    metadata{      dimensions    }  }}    }  }},  _type == "columns" => {    ...,    columns[]{      ...,      content[]{        ...,        markDefs[]{  ...,  _type == "internalLink" => {    "slug": @.reference->slug.current,    "refType": @.reference->_type  },  _type == "link" => {    ...,  }},        _type == "media" => {  ...,  media{    ...,    asset->{  _id,  url,  mimeType,  originalFilename,  size}  }},        _type == "videoFile" => {  ...,  asset->{  _id,  url,  mimeType,  originalFilename,  size},  poster{  ...,  asset->{    _id,    url,    mimeType,    metadata{      dimensions    }  }}},        _type == "gallery" => {  ...,  images[]{    ...,    _type == "galleryVideo" => {      ...,      asset->{  _id,  url,  mimeType,  originalFilename,  size},      poster{  ...,  asset->{    _id,    url,    mimeType,    metadata{      dimensions    }  }}    }  }}      }    }  }},  "content": content[]{  ...,  markDefs[]{  ...,  _type == "internalLink" => {    "slug": @.reference->slug.current,    "refType": @.reference->_type  },  _type == "link" => {    ...,  }},  _type == "media" => {  ...,  media{    ...,    asset->{  _id,  url,  mimeType,  originalFilename,  size}  }},  _type == "videoFile" => {  ...,  asset->{  _id,  url,  mimeType,  originalFilename,  size},  poster{  ...,  asset->{    _id,    url,    mimeType,    metadata{      dimensions    }  }}},  _type == "gallery" => {  ...,  images[]{    ...,    _type == "galleryVideo" => {      ...,      asset->{  _id,  url,  mimeType,  originalFilename,  size},      poster{  ...,  asset->{    _id,    url,    mimeType,    metadata{      dimensions    }  }}    }  }},  _type == "columns" => {    ...,    columns[]{      ...,      content[]{        ...,        markDefs[]{  ...,  _type == "internalLink" => {    "slug": @.reference->slug.current,    "refType": @.reference->_type  },  _type == "link" => {    ...,  }},        _type == "media" => {  ...,  media{    ...,    asset->{  _id,  url,  mimeType,  originalFilename,  size}  }},        _type == "videoFile" => {  ...,  asset->{  _id,  url,  mimeType,  originalFilename,  size},  poster{  ...,  asset->{    _id,    url,    mimeType,    metadata{      dimensions    }  }}},        _type == "gallery" => {  ...,  images[]{    ...,    _type == "galleryVideo" => {      ...,      asset->{  _id,  url,  mimeType,  originalFilename,  size},      poster{  ...,  asset->{    _id,    url,    mimeType,    metadata{      dimensions    }  }}    }  }}      }    }  }}}
...
// Query: *[_type == "project"] | order(orderRank) {  _id,  _type,  "isDraft": _id in path("drafts.**") || _originalId in path("drafts.**"),  _createdAt,  name,  "slug": slug.current,  "image": image.asset->url,  archived,  type,  svgcode,  subtitle,  color,  displayType,  embedUrl,  aspectRatio,  url}
...
// Query: *[_type == "project" && type == "personal"] | order(orderRank) {  _id,  _type,  "isDraft": _id in path("drafts.**") || _originalId in path("drafts.**"),  _createdAt,  name,  "slug": slug.current,  "image": image.asset->url,  archived,  type,  svgcode,  subtitle,  color,  displayType,  embedUrl,  aspectRatio,  url}
...
// Query: *[_type == "project" && type == "client"] | order(orderRank) {  _id,  _type,  "isDraft": _id in path("drafts.**") || _originalId in path("drafts.**"),  _createdAt,  name,  "slug": slug.current,  "image": image.asset->url,  archived,  type,  svgcode,  subtitle,  color,  displayType,  embedUrl,  aspectRatio,  url}
...
// Query: *[_type == "page" && defined(slug.current)]{  _id,  _createdAt,  title,  "slug": slug.current}
